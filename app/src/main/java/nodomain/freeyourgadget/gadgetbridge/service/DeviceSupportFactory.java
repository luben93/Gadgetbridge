...
import nodomain.freeyourgadget.gadgetbridge.service.devices.riotwatch.RiotWatchSupport;
            ...
            try {
                switch (gbDevice.getType()) {
                    ...
                    case WATCH9:
                        ...
                        break;
                    case RIOTWATCH:
                        deviceSupport = new ServiceDeviceSupport(new RiotWatchSupport(), EnumSet.of(ServiceDeviceSupport.Flags.BUSY_CHECKING));
                        break;
                    case ROIDMI:
